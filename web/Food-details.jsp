...
<%
    ...
    ResultSet rs = stm.executeQuery("select * from product WHERE product_category = Food&Beverage AND product_id = 4");
%>
...
<div class="row-product">
    ...
    <div class="details">
        <p style="padding-top: 70px"><h1><%=rs.getInt("product_name")%></h1></p>
        <br>
